...
public interface IRiverCrossingController {
	/**
	 * this method initialize the controller with game strategy according to the
	 * level
	 * 
	 * @param gameStrategy
	 */
	...
	/**
	 * @return determines whether the boat is on the left or on the right bank of
	 *         the river
	 */
	...
	/**
	 * saves the game state (left bank crossers, right bank crossers, number of done
	 * sails, position of the boat)
	 */
	...
	/**
	 * this function is bonus it returns the boat riders starting from the beginning
	 * of the game until the final solution to show the user the solution
	 */
